...
public class GUI extends Paper implements InputProcessor {
	...
	public void hide() {
		// TODO Auto-generated method stub
		if (this.menu.item.isFocused)
			this.menu.item.setFocus(false);
		if (this.menu.equipe.isFocused)
			this.menu.equipe.setFocus(false);
		this.hiding = true;
	...
	public boolean isActing() {
		// TODO Auto-generated method stub
		if (super.isActing() || this.itempane.isActing()
				|| this.equipepane.isActing()) {
			return true;
		} else
			return false;
	}
